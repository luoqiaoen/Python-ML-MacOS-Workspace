...
#parameters lifted by published works, note hyper parameters are very important
#for successful training of GAN and it is difficult to find the good ones
...
# samples folder to put generated figures in
...
class ConvLayer:
  def __init__(self, name, mi, mo, apply_batch_norm, filtersz=5, stride=2, f=tf.nn.relu):
    ...
    # this name setup will allow to reuse convlayer to define all convlayers in DCGAN
